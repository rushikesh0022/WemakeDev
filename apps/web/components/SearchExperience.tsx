...
export function SearchExperience() {
  ...
  return (
    <div className="search-page">
      {!result && !loading && <div className="search-empty"><div>⌕</div><h1>Start with the search above</h1><p>Find products normally, then ask Zaply to turn the same query into a complete basket.</p></div>}
